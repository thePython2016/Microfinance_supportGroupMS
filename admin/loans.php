       ...
       <form name="" method="POST" action="loanAdd.php">
        <div class="first-block">
          ...
          <div class="mb-3 nin">
            ...
            <input type="date" class="form-control" name="loan_date" id="loan_date" aria-describedby="emailHelp" required>
          </div>
        ...
        <div class="second-block">
          ...
          <!-- Total Payable (auto-calculated, read-only) -->
          <div class="mb-3 fname">
        ...
        <div class="mb-3">
          ...
          <textarea class="form-control" id="notes" name="notes" rows="3" placeholder="Additional notes..." style="background-color:white !important;resize:vertical"></textarea>
        </div>
        ...
        <div class="tab-pane fade" id="editUpdate" role="tabpanel" aria-labelledby="tab2-tab">
            <div class="container">
            <table id="membersTable" class="table mb-5 table-striped table-bordered" style="width:1000px !important">
            <thead>
                <tr>
                    <th>Loan Date</th>
                    <th>Due Date</th>
            ...
            <tbody>
              <?php
                 ...
                 foreach($selectShares ?: [] as $shares) {
                   ?>
                <tr>
                    <td><?php echo $shares['loan_date']?></td>
                    <td><?php echo $shares['due_date']?></td>
                    <td><a class="url" href="member.php?number=<?php echo $shares['member_id']?>"><?php echo $shares['member_id']?></a></td>
                    <td><?php echo $shares['amount']?></td>
                    <td><?php echo $shares['interest_rate']?>%</td>
                    <td><?php echo $shares['total_payable']?></td>
                    <td><?php echo $shares['month']?></td>
                    <td><?php echo $shares['year']?></td>
                    <td><?php echo $shares['status']?></td>
                    <td><?php echo $shares['notes']?></td>
                </tr>
              <?php } ?>
            </tbody>
        </table>
