...
if (isset($_POST['addLoan'])) {
    ...
    $mobilenumber  = finance_db_escape($connection, $_POST['member_id']    ?? '');
    ...
    $result = finance_db_query($connection,
        "INSERT INTO loans
            (mobilenumber, amount, interest_rate, total_payable, loan_date, due_date, status, notes)
         VALUES
            ('$mobilenumber', '$amountEsc', '$interestRateEsc', '$totalPayableEsc',
