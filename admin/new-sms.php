...
<hr>
    ...
    <input type="text" class="form-control" name="sender" id="lname" required placeholder="Sender name">
    <input type="hidden" class="form-control" name="id" id="id" required placeholder="Sender name">
  </div>
