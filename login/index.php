        ...
        <div class="card my-5 ">
          ...
          <form class="card-bodycolor  p-lg-5" name="form" action="authenticate.php" method="POST">
            ...
            <div class="text-center">
              <img src="images/logo.png" class="img-fluid profile-image-pic img-thumbnail rounded-circle"
                width="150px" alt="profile">
            </div>

            <div class="mb-3 mt-5 form-floating">
              <input type="text" class="form-control" id="floatingInput" name="username" id="Username" aria-describedby="emailHelp"
